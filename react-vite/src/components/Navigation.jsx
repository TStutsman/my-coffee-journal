...
function Navigation() {
    return (
        <>
            <nav>
                <NavLink to="/coffees">
                <svg id='coffee-icon' stroke-miterlimit="10" version="1.1" viewBox="0 0 180 180" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill='currentColor'>
                ...
                <NavLink to="/coffees/new">+ Coffee</NavLink>
                ...
                <NavLink to="/brews/new">+ Brew</NavLink>
            </nav>
        </>
    )
}
